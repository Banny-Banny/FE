...
export const styles = StyleSheet.create({
  ...
  // 진행 바 컨테이너 (contentContainer와 같은 너비)
  progressContainer: {
    width: 234, // content 너비 260px - paddingHorizontal 26px (13px * 2)
    height: 6,
    backgroundColor: Colors.whiteGrey[200], // Figma 디자인: #f3f4f6
  ...
  progressBar: {
    height: 6,
    backgroundColor: Colors.black[500], // Figma 디자인: #111827
    borderRadius: BorderRadius.full,
  },
});
