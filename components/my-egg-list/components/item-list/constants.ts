...
// assets/images의 이미지 사용 - 모든 아이템에 filled_egg.svg 사용
const EGG_ICON = require('@/assets/images/filled_egg.svg');
...
export const MOCK_DISCOVERED_ITEMS: ItemProps[] = [
  ...
  },
  {
    ...
    title: '생일 파티',
    description:
      '내 생일에 몰래 준비한 깜짝 파티 진짜 최고였어! 케이크 들고 나타났을 때 울컥했었다는 거 들켰지?',
    location: '서울 강남',
    date: '2024-11-28',
    eggIcon: EGG_ICON,
    hasImage: true,
